...
# ===== EMBEDDED RESTORED BACKUP =====
import base64 as _agni_base64
from pathlib import Path as _agni_Path

_AGNI_EMBEDDED_DB = ''
_AGNI_EMBEDDED_SETTINGS = ''

def _agni_restore_embedded_backup():
    _db = _agni_Path("agni_data.sqlite3")
    _settings = _agni_Path("bot_settings.json")
    if not _db.exists():
        _db.write_bytes(_agni_base64.b64decode(_AGNI_EMBEDDED_DB))
    if not _settings.exists():
        _settings.write_bytes(_agni_base64.b64decode(_AGNI_EMBEDDED_SETTINGS))

_agni_restore_embedded_backup()
# ===== END EMBEDDED RESTORED BACKUP =====
...
# Seed from the supplied backup. Restore only on a fresh deployment; never overwrite
# an existing live database or settings file.
_BACKUP_DB_B64 = ""
_BACKUP_CONFIG_B64 = ""

def restore_supplied_backup_if_missing():
    try:
        db_path = Path("agni_data.sqlite3")
        if not db_path.exists():
            import base64 as _base64
            db_path.write_bytes(_base64.b64decode(_BACKUP_DB_B64))
            print("[RESTORE] Supplied Agni database backup restored.")
        cfg_path = Path(CONFIG_FILE)
        if not cfg_path.exists():
            import base64 as _base64
            cfg_path.write_bytes(_base64.b64decode(_BACKUP_CONFIG_B64))
            print("[RESTORE] Supplied bot settings backup restored.")
    except Exception as e:
        print(f"[RESTORE ERROR] {type(e).__name__}: {e}")

restore_supplied_backup_if_missing()
...
async def create_ticket(interaction, panel_id, button_id, button_label, questions, answers=None):
    ...
    try:
        ...
        if not me or not me.guild_permissions.manage_channels:
            return await interaction.followup.send("❌ I need **Manage Channels** permission to create tickets.", ephemeral=True)
        ...
        return await interaction.followup.send("❌ Failed to create the ticket. Check category, role and bot permissions.", ephemeral=True)
...
class TicketSetupModal(discord.ui.Modal):
    def __init__(self, category, role):
        # Discord modals allow a maximum of 5 text inputs. Keep setup valid;
        # all 4 optional questions remain available through Edit Button.
        ...
        self.question1 = discord.ui.TextInput(label="Question 1 (Optional)", required=False, max_length=100)
        self.question2 = discord.ui.TextInput(label="Question 2 (Optional)", required=False, max_length=100)
        for x in (self.panel_title, self.panel_desc, self.btn_name, self.question1, self.question2):
            self.add_item(x)
    ...
    async def on_submit(self, interaction):
        try:
            ...
            questions = [q.value.strip() for q in (self.question1, self.question2) if q.value.strip()]
            panel["buttons"][first] = {"label": self.btn_name.value.strip() or "Support", "questions": questions}
            if not data:
                ticket_configs[guild.id] = {"active_panel": pid, "panels": {pid: panel}}
            else:
                data.setdefault("panels", {})[pid] = panel
            ...
            print(f"[TICKET SETUP ERROR] {type(e).__name__}: {e}")
            try:
                if interaction.response.is_done():
                    await interaction.followup.send("❌ Ticket setup failed. Check the bot permissions and try again.", ephemeral=True)
                else:
                    await interaction.response.send_message("❌ Ticket setup failed. Check the bot permissions and try again.", ephemeral=True)
            except Exception as response_error:
                print(f"[TICKET SETUP RESPONSE ERROR] {type(response_error).__name__}: {response_error}")
...
async def on_member_join(member):
    ...
    # Never let invite/raid logging prevent the welcome event from completing.
    try:
        await handle_raid_join(member)
    except Exception as e:
        print(f"[RAID JOIN ERROR] {type(e).__name__}: {e}")
    ...
    try:
        ...
        print(f"[INVITE JOIN ERROR] {type(e).__name__}: {e}")

    try:
        await send_log(guild, "📥 Member Joined", f"**Member:** {member.mention} (`{member.id}`)", discord.Color.green(), "member")
    except Exception as e:
        print(f"[MEMBER JOIN LOG ERROR] {type(e).__name__}: {e}")

    try:
        db_invite_log_id = get_guild_setting(guild.id, "invite_log_channel_id")
        if db_invite_log_id:
            log_channel = guild.get_channel(int(db_invite_log_id))
            if log_channel:
                inviter_str = inviter_user.mention if inviter_user else "Unknown Link"
                embed = discord.Embed(title="📥 Member Joined via Invite", description=f"**Member:** {member.mention}\n**Invited By:** {inviter_str}", color=discord.Color.green(), timestamp=datetime.now(timezone.utc))
                embed.set_thumbnail(url=member.display_avatar.url)
                await log_channel.send(embed=embed)
    except Exception as e:
        print(f"[INVITE LOG ERROR] {type(e).__name__}: {e}")

    try:
        await on_member_join_autorole(member)
    except Exception as e:
        print(f"[AUTOROLE JOIN ERROR] {type(e).__name__}: {e}")

    # Welcome settings are guild-specific; do not use the old global variables.
    try:
        welcome_enabled_db = bool(get_guild_setting(guild.id, "welcome_enabled", 0))
        if not welcome_enabled_db:
            return
        welcome_channel_db = get_guild_setting(guild.id, "welcome_channel_id")
        welcome_msg_db = get_guild_setting(guild.id, "welcome_message")
        welcome_img_db = get_guild_setting(guild.id, "welcome_image")
        target_channel = guild.get_channel(int(welcome_channel_db)) if welcome_channel_db else guild.system_channel
        if not target_channel:
            print(f"[WELCOME] No valid welcome channel configured for {guild.name}")
            return
        if welcome_msg_db:
            try:
                description_text = str(welcome_msg_db).format(user=member.mention, server=guild.name, count=guild.member_count, inviter=inviter_user.name if inviter_user else "Unknown")
            except Exception:
                description_text = str(welcome_msg_db)
        else:
        ...
        embed.set_thumbnail(url=member.display_avatar.url)
        if welcome_img_db:
            embed.set_image(url=str(welcome_img_db))
...
async def send_mod_result(ctx, text=None, ephemeral=False, **kwargs):
    try: return await ctx.send(text, ephemeral=ephemeral, **kwargs)
    except TypeError: return await ctx.send(text, **kwargs)
